...
<?php
			if ($adminPageAccessPermissions->updateContent) {
?>
				<td class="generic_row_link"><span><a href="./websection_downloads.php?downloadID=<?php print $download->id; ?>&amp;fileID=<?php print $fileItem->id; ?>"><?php print encodeHtml($fileItem->title);?></a>
                <!--copy to clipboard button  --><br />
   <script src="//cdnjs.cloudflare.com/ajax/libs/clipboard.js/1.5.12/clipboard.min.js"></script>
<script>
new Clipboard('.fu_copytocbbtn');
</script>
                <button class="fu_copytocbbtn" data-clipboard-text="<?php print DOMAIN ."/download/downloads/id/" . $fileItem->id ."/" . $filename; ?>">Copy PDF URL to Clipboard</button>
                </span>
